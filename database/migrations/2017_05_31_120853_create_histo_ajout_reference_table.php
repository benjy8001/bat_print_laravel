...
class CreateHistoAjoutReferenceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('histo_ajout_reference', function (Blueprint $table) {
            // $table->uuid('pk_id');
            // $table->primary('pk_id');
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('histo_ajout_reference');
    }
}
